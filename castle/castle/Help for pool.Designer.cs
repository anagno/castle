namespace Castle
{
    partial class Help_for_pool
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Help_for_pool));
            ...
            this.label2.Text = "Ενεργοποιεί ή απενεργοποιεί τον συναγερμό για την πόρτα.";
            // 
            // label3
            // 
            ...
            this.label4.Text = "Ανοίγει ή κλείνει την κεντρική πόρτα της καστροπολιτείας.";
            // 
            // label5
            // 
            ...
            this.label6.Text = "Ρυθμίζει την θερμοκρασία της πισήνας.";
            // 
            // label7
            // 
            ...
            this.label8.Text = "Ρυθμίζει την στάθμη της πισήνας.";
            // 
            // button1
            // 
            ...
            this.Name = "Help_for_pool";
            this.Text = "Βοήθεια Πισίνας!";
